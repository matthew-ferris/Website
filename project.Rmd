...
Due to the data being unbalanced, I have run two models with KNN. The first is the standard, while in the second I implement SMOTE sampling. You can click through the two tabs below to see each of the models.
...
ConfusionMatrix<-confusionMatrix(knn_pred_sm,as.factor(DataTest$GOING_CONCERN))
```
